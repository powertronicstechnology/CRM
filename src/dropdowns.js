export const DROPDOWN_LABELS = { panel: 'Panels', inverter: 'Inverters', meter_phase: 'Meter phases', payment_method: 'Payment methods', project_type: 'Project types', financial_tag_general: 'Financial tags · General', financial_tag_surya: 'Financial tags · PM Surya' };
export const DROPDOWN_DEFAULTS = {"panel": ["ADANI", "WAAREE", "PAHAL", "ADANI TOPCON", "WAAREE TOPCON", "PAHAL TOPCON"], "inverter": ["SOLARYAAN", "KSOLARE", "GROWATT", "POLYCAB", "WAAREE", "YAAN"], "meter_phase": ["S", "T", "T (EXTEN)"], "payment_method": ["ONL", "CHQ", "DD", "CASH"], "project_type": ["General", "PM SURYA"], "financial_tag_general": ["Initial", "Installation", "Final payment"], "financial_tag_surya": ["Registration payment 20k", "Installation payment", "Quotation amount", "Final payment after meter installation"]};
